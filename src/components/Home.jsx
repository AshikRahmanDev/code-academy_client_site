      ...
      <div className="grid md:grid-cols-2 w-[95%] mx-auto">
        <div className="md:ml-7 md:mt-7 text-center md:text-start">
          ...
          <div className="mt-7 text-center md:text-start">
            <Link
              to={"/courses"}
              className="btn bg-yellow-400/30 hover:bg-yellow-500 border-2 border-yellow-400/50 mr-4"
            >
              Explore Courses
            </Link>
            <Link
              to={"/register"}
              className="btn bg-transparent border-2 hover:bg-yellow-500 border-yellow-400/50 mr-4"
            >
              Register
            </Link>
          </div>
        ...
        <div className="w-[100%] relative hidden md:block">
          <img
            ...
            border="0"
          ></img>
          <div className="flex items-center justify-center absolute top-16 left-16 rounded-full w-[150px] h-[150px] bg-yellow-400/50 border-2 border-yellow-400">
          ...
          <div className="flex items-center justify-center absolute top-0 right-16 rounded-full w-[150px] h-[150px] bg-yellow-400/50 border-2 border-yellow-400">
            <div className="flex flex-col justify-center items-center text-white font-semibold">
              <MdOutlineLibraryBooks className="text-3xl" />
